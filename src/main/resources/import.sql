INSERT INTO Local (id, name, address, url_image) VALUES (nextval('local_seq'), 'Location1', '123 Main St, Cityville', '/images/local/locale1.jpg');
INSERT INTO Local (id, name, address, url_image) VALUES (nextval('local_seq'), 'Location2', '456 Elm St, Townsville', '/images/local/locale2.jpg');
INSERT INTO Local (id, name, address, url_image) VALUES (nextval('local_seq'), 'Location3', '789 Oak St, Villageville', '/images/local/locale3.jpg');
